...
![Базовая архитектура](pics/drone-inspector_basic-arch.png)

Базовая диаграмма последовательности

![Диаграмма последовательности](pics/drone-inspector_basic-sd.png)
...
![Переработанная архитектура](pics/drone-inspector_security-arch.png)
